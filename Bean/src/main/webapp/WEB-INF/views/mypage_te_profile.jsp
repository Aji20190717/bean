					...
					<div class="col-md-6 ml-auto mr-auto">
						<div class="profile">
							...
							<div class="name">
								...
								<button onclick="location.href='mypagedetail.do'" class="btn">class 관리</button>
								<button onclick="location.href='logout.do'" class="btn">로그아웃</button>
								<button onclick="location.href='location.href='studentRun.do?member_no=${login.member_no}&class_no=${classDto.class_no }'" class="btn">회원
									탈퇴</button>
								<button onclick="location.href='location.href='myinfoupdateform.do'" class="btn">정보
									수정</button>
							</div>
						</div>
					</div>
